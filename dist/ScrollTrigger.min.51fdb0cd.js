...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"public/js/library/ScrollTrigger.min.js":[function(require,module,exports) {
var define;
    ...
    if (this.progress = this.start = 0, this.vars && this.kill(1), Ue) {
      ...
      we.media = Ve, ce *= 45, we.scroller = he, we.scroll = P(he, re), k = we.scroll(), we.vars = S, M = M || S.animation, "refreshPriority" in S && (Re = 1), l.tweenScroll = l.tweenScroll || {
        ...
        if (!Be && we.enabled || t) if (ae && e && je) Ca(ScrollTrigger, "scrollEnd", Va);else {
          ...
          for (var r, n, o, i, a, s, l, c, u, f, p = Ce(), d = Te(), g = T(he, re), h = 0, v = 0, m = S.end, b = S.endTrigger || ie, x = S.start || (0 !== S.start && ie ? ae ? "0 0" : "0 100%" : 0), y = S.pinnedContainer && Ee(S.pinnedContainer)[0], w = ie && Math.max(0, lt.indexOf(we)) || 0, C = w; C--;) {
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","public/js/library/ScrollTrigger.min.js"], null)
//# sourceMappingURL=/ScrollTrigger.min.51fdb0cd.js.map