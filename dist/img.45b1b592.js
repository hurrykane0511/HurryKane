...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"public/js/img.js":[function(require,module,exports) {
...
var backgroundColor = ['#e2cfad', '#837877', '#f3abb7', '#b9aca6'];

function addFilter() {
  for (var i = 2; i <= 12; i++) {
    var clone = noise.cloneNode(true);
    clone.id = "noise".concat(i);
    filter.append(clone);
  }

  var allfilter = document.querySelectorAll('.turbulence');
  var p = 0;

  for (var _i = 1; _i <= 4; _i++) {
    for (var j = 1; j <= 3; j++) {
      allfilter[p].setAttribute('class', "turbulence".concat(_i));
      p++;
    }
  }
}
...
navlinks.forEach(function (link) {
  link.addEventListener('mouseover', function () {
    var current_img = filterLink(link);
...
function hover(el, filter) {
  ...
  gsap.to(".turbulence".concat(filter), {
    stagger: {
      amount: .5
    },
    attr: {
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","public/js/img.js"], null)
//# sourceMappingURL=/img.45b1b592.js.map